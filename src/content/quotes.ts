...
export const reflections:Reflection[]=[
  ...
  {id:'furor-sanandi',author:'Proyecto Salida',text:'El apuro por arreglarlo todo hoy también puede jugar en contra.',source:'Copy propio, inspirado en la idea psicoanalítica del furor sanandi',type:'paraphrase',contextTags:['support','deficit']},
  {id:'micro',author:'Proyecto Salida',text:'Un poco también mueve la barra.',type:'paraphrase',contextTags:['progress','plan']}
]
