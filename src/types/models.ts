...
export interface BackupData { schemaVersion: 2; exportedAt: string; incomes: Income[]; expenses: Expense[]; debts: Debt[]; payments: DebtPayment[]; snapshots: MonthlySnapshot[]; savingsGoals: SavingsGoal[]; settings: Settings; exchangeRates: ExchangeRate[] }
